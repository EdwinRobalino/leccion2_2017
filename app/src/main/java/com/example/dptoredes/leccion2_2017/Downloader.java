...
public class Downloader extends IntentService {
    ...
    private String[] parseResult(String result) {
        ...
        try {
            ...
            JSONArray posts = response.optJSONArray("userId"); //Obtener el listado del Json
            Log.e("Num", " "+posts.length());
            ...
            for (int i = 0; i < posts.length(); i++) {
                ...
                String mvp_id = post.optString("monster_id"); //Obtener el id
                mvp_list[i] = mvp_id;
